...
public abstract class Angelique extends PropertyUnit {
    protected static final int    FLOOR_AREA       = 35;
    ...
    public Angelique(String modelName, int lotArea, double estimatedTCP, double loanableAmount, double downPayment, double dpTarget) {
